          ...
          <div className="container mx-auto px-6 py-24">
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <button className="border border-white hover:bg-white/10 text-white font-medium px-10 py-4 rounded transition duration-300">
                  About us
                </button>
      ...
      <RevealOnScroll>
        <section id='benefits' className="py-16 px-4 max-w-6xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-2">
            ...
            <span className="text-blue-500">FoxSolutions?</span>
          </h1>
...
const WebDevelopemnt = () => {
    ...
    const contentsMenu = [
        ...
        { title: 'About foxsolutions', id: 'about' },
        { title: 'FAQ', id: 'faq' },
        { title: 'Blog', id: 'blog' }
    ];
