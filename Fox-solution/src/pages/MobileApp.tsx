...
const WhyChooseFoxSolutions = () => {
  return (
    <section id="why" className="py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold mb-12 text-center">
          <span className="text-blue-500">Why</span> choose FoxSolutions
        </h2>
...
const FAQSection = () => {
  const MobileAppFAQSection = [
    {
      question: "What is FoxSolutions known for in the realm of a mobile app development?",
    ...
    {
      question: "What types of mobile app development services does FoxSolutions offer?",
    ...
    {
      question: "How does FoxSolutions ensure the quality of its mobile applications?",
    ...
    {
      question: "Can FoxSolutions build mobile apps for both iOS and Android platforms?",
    ...
    {
      question: "How does FoxSolutions approach client involvement during the app development process?",
    ...
    {
      question: "What makes FoxSolutions stand out from other mobile app development companies?",
    ...
    {
      question: "Does FoxSolutions provide post-launch support and maintenance for mobile apps?",
    ...
    {
      question: "Can FoxSolutions help in updating and optimizing existing mobile applications?",
...
const MobileAppDevelopemnt = () => {
    ...
    const contentsMenu = [
        ...
        { title: 'Why choose foxsolutions?', id: 'why' },
