...
const Careers = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center mb-8">
                        <h1 className="text-6xl font-normal mb-8 text-blue-400">
                            Careers <span className="text-white">at Foxsolutions</span>
                        </h1>
            ...
            <div className="container mx-auto px-4 mb-12 mt-12 text-center">
                ...
                <div className="max-w-3xl mx-auto">
                    <p className="text-black font-light text-lg md:text-xl mb-8">
                        Official communication for job openings at Foxsolution will ONLY be conducted through our corporate email:
                        <span className="font-medium text-blue-600"> resume@foxsolution.com</span>. Be cautious of alternative email addresses.
                    </p>

                    <p className="text-black font-light text-lg md:text-xl mb-10">
                        Foxsolution will <span className="font-semibold">NEVER</span> request payment for job applications, secure deposits, or visa processing.<br />
            ...
            <h1 className="text-5xl font-normal mb-4 mt-16 text-center">Open<span className="text-blue-600"> Positions</span></h1>
